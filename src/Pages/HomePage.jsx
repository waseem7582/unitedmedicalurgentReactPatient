          ...
          >
            <Box pb={12} flex={1} maxW={"100%"}>
              ...
              <Text
                ...
                fontWeight={400}
              >
                Experience world-class medical care with {name.value}:
                management, dedicated professionals, and compassionate treatment — all focused on building a healthier tomorrow for you and your family.
              </Text>
            ...
            >
                ...
                <Box p={12} display={"flex"} alignItems={"center"}>
                  <Box>
                    ...
                    <Text color={"#FFF"} fontWeight={500}>
                      Have questions or need assistance? We’re just a message away — ready to help you with care and confidence.
                    </Text>
                  </Box>
                </Box>
                <Button
              ...
              >
                <Box p={8}>
                  ...
                  <Text color={"#FFF"} fontWeight={500}>
                    From late-night emergencies to early-morning checkups — we’re here around the clock to keep you safe, healthy, and cared for.
                  </Text>
                </Box>
              </GridItem>
              <GridItem
              ...
              >
                <Box p={8}>
                  ...
                  <Text color={"#FFF"} fontWeight={500}>  
                    Our commitment to excellence drives us to use cutting-edge medical technology 
                    that enhances accuracy, safety, and outcomes for every patient we serve.
                  </Text>
                </Box>
              </GridItem>
            </Grid>
          ...
          <Flex gap={5} pt={16} flexDir={{ base: "column", md: "row" }}>
            ...
            <Box flex={1} pb={10}>
              <Text
                ...
                color={"gray.600"}
              >
                We’re Committed to Your Health <br />
                <Text as={"span"} color={"primary.text"} fontWeight={600}>
                  
                </Text>{" "}
                Ensuring Your Well-Being With Every Visit
              </Text>
              <Text fontSize={16} mt={2} color={"gray.500"} fontWeight={500}>
                Pain and symptom relief are central to our palliative and hospice care services, helping patients live more comfortably and confidently.
              </Text>
              <List
                spacing={5}
                textAlign="start"
              ...
              >
                ...
                <ListItem>
                  <ListIcon
                    ...
                    fontSize={20}
                  />
                  Exclusive Discounts on All Treatments
                </ListItem>
                <ListItem>
                  <ListIcon
                    as={FaCheckCircle}
        ...
        <div className="container">
          <Box>
            ...
            >
              ...
              are our top priority. <br /> Here{"`"}s why patients trust us to care for what matters most — their health, comfort, and peace of mind.
            </Text>
            <Box mt={5}>
              <Grid
                templateColumns={{
              ...
              >
                ...
                >
                  <Box p={5}>
                    ...
                    <Text fontSize={14}>
                      At {name.value}, we believe every patient deserves individualized attention. 
                      Our team delivers care that’s customized to your condition, lifestyle, and 
                      preferences — ensuring the best possible outcomes for your health and well-being.
                ...
                >
                  <Box p={5}>
                    ...
                    <Text fontSize={14}>
                      Behind every great recovery is a great team. At UnitedMedicalUrgentCare, our skilled doctors, 
                      caring nurses, and dedicated support staff work together to ensure you receive 
                      the highest standard of medical care, delivered with empathy and excellence.
                    </Text>
                  </Box>
                </GridItem>
                <GridItem
                ...
                >
                  <Box p={5}>
                    ...
                    <Text fontSize={14}>
                      Experience healthcare at its finest. At {name.value}, our modern hospital 
                      environment and advanced medical systems ensure you receive the highest 
                      quality of care — efficiently, safely, and comfortably.
                    </Text>
                  </Box>
                </GridItem>
              </Grid>
          ...
          <Flex p={3} align={"center"} flexDir={{ base: "column", md: "row" }}>
            ...
            <Box flex={1}>
              ...
              <Text
                ...
                color={"gray.600"}
              >
                At UnitedMedicalUrgentCare, we redefine convenience in healthcare. Our integrated system 
                connects you with specialists, services, and treatment plans — all in one 
                place for a smoother, faster, and more reliable experience.
              </Text>
            </Box>
          </Flex>
          <Box mt={10}>
